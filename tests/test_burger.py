...
from data import  SECOND_INGREDIENT_NAME, SECOND_INGREDIENT_PRICE, SECOND_INGREDIENT_TYPE
...
class TestBurger:
    ...
    def test_move_ingredient(self, mock_ingredient):
        ...
        ingredient_second = MagicMock()
        ingredient_second.get_price.return_value = SECOND_INGREDIENT_PRICE
        ingredient_second.get_name.return_value = SECOND_INGREDIENT_NAME
        ingredient_second.get_type.return_value = SECOND_INGREDIENT_TYPE
